# _Allergy Finder, PHP Classwork for Epicodus_
...
_This is daily pair-programming classwork, likely in draft form, for the PHP class at Epicodus.  This uses a base-2 table to convert a number into a list of allergies that the number represents. _
